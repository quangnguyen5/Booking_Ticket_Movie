<%-- 
    Document   : home
    Created on : Nov 6, 2022, 3:57:09 PM
    Author     : LEGION 5
--%>
                        ...
                        <li>
                            <div class="slider-info banner-view bg bg2">
                                <div class="banner-info">
                                    ...
                                    <p>Biệt đội siêu anh hùng là một bộ phim siêu anh hùng của Mỹ công chiếu vào năm 2012 được xây dựng dựa trên nguyên mẫu các thành viên của biệt đội siêu anh hùng Avengers của Marvel Comics, <span class="over-para">
                                            do Marvel Studios sản xuất và Walt Disney Studios Motion Pictures phân phối phát hành.   </span></p>
                        ...
                        <li>
                            <div class="slider-info  banner-view banner-top1 bg bg2">
                                <div class="banner-info">
                                    ...
                                    <p>Nữ hoàng băng giá II là phim điện ảnh hoạt hình máy tính nhạc kịch kỳ ảo của Mỹ năm 2019 do Walt Disney Animation.<span class="over-para">
                                            sản xuất và Walt Disney Studios Motion Pictures chịu trách nhiệm phân phối.</span></p>
                    ...
                    <div class="item">
                        <li>
                            <div class="slider-info banner-view banner-top2 bg bg2">
                                <div class="banner-info">
                                    <h3>Latest Movie Trailers</h3>
                                    <p>Joker là một bộ phim điện ảnh giật gân tâm lý của Mỹ năm 2019 do Todd Phillips chịu trách nhiệm đạo diễn kiêm sản xuất<span class="over-para">
                                           với phần kịch bản do anh chấp bút cùng nhà biên kịch Scott Silver.</span></p>
                    ...
                    <div class="item">
                        <li>
                            <div class="slider-info banner-view banner-top3 bg bg2">
                                <div class="banner-info">
                                    <h3>Latest Online Movies</h3>
                                    <p>Aladdin là phim điện ảnh nhạc kịch kỳ ảo của Mỹ do Guy Ritchie đạo diễn, <span class="over-para">
                                            từ phần kịch bản do anh thực hiện cùng với John August </span></p>
