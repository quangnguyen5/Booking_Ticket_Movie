                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="Login_SignUp" id="login"
                             style="font-size: 2rem ; display: inline-block; position: relative;">
                            <!-- <li class="nav-item"> -->
                            <a class="nav-link" <c:if test= "${sessionScope.customer != null}">href="bill.jsp"</c:if> <c:if test= "${sessionScope.customer == null}">href="bill.jsp"</c:if> ><i class="fa fa-ticket"></i></a>
                            <!-- </li> -->
                        </div>
            ...
            <div class="grids-main py-5">
                <div class="container py-lg-4">
                    ...
                    <div class="w3l-populohny-grids">
                        <h2>Bạn chưa có vé xem phim nào cho mình hãy <a href="movies">đặt ngay</a> nào >< </h2>
                    </div>
                </div>
