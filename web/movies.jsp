<%-- 
    Document   : movies
    Created on : Nov 6, 2022, 3:54:35 PM
    Author     : LEGION 5
--%>
        ...
        <section class="w3l-grids">
            <div class="grids-main py-5">
                <div class="container py-lg-4">
                        ...
                        <div class="w3l-title-grids">
                            ...
                            <form ac>
                                <div class="headerhny-right text-lg-right">
                                    <h4><a href="show_all" class="show-title">Show all</a></h4>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="w3l-title-grids">
                        <div class="headerhny-left">
                            <h3 class="hny-title">Action</h3>
                        </div>
                        <div class="headerhny-right text-lg-right">
                            <h4><a class="show-title" href="show_all">Show all</a></h4>
                        </div>
                    </div>
                    <div class="w3l-populohny-grids">
                        <c:forEach items="${listMovieAction}" var="m">
                            <!-- START DIV MOVIE -->
                            <div class="item vhny-grid"> 
                                <div class="box16 mb-0">
                                    <figure>
                    ...
                    <div class="w3l-title-grids">
                        <div class="headerhny-left">
                            <h3 class="hny-title">Animation</h3>
                        </div>
                        <div class="headerhny-right text-lg-right">
                    ...
                    <div class="w3l-populohny-grids">
                        <c:forEach items="${listMovieAnimation}" var="m">
                            <!-- START DIV MOVIE -->
                            <div class="item vhny-grid"> 
                                <div class="box16 mb-0">
                                    <figure>
                    ...
                    <div class="w3l-title-grids">
                        <div class="headerhny-left">
                            <h3 class="hny-title">Horrified</h3>
                        </div>
                        <div class="headerhny-right text-lg-right">
                            <h4><a class="show-title" href="movies">Show all</a></h4>
                        </div>
                    ...
                    <div class="w3l-populohny-grids">
                        <c:forEach items="${listMovieHorrified}" var="m">
                            <!-- START DIV MOVIE -->
                            <div class="item vhny-grid"> 
                                <div class="box16 mb-0">
                                    <figure>
                    ...
                    <div class="w3l-populohny-grids">
                        <c:forEach items="${listMovieRomance}" var="m">
                            <!-- START DIV MOVIE -->
                            <div class="item vhny-grid"> 
                                <div class="box16 mb-0">
                                    <figure>
                    ...
                    <div class="w3l-populohny-grids">
                        <c:forEach items="${listMoviesHumor}" var="m">
                            <!-- START DIV MOVIE -->
                            <div class="item vhny-grid"> 
                                <div class="box16 mb-0">
                                    <figure>
